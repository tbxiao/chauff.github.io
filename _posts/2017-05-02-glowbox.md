...
Together with [Djoerd Hiemstra](http://wwwhome.ewi.utwente.nl/~hiemstra/) (who is also behind [Searsia](http://searsia.org/) which powers the [search functionality of the University of Twente](https://search.utwente.nl/)) and [Leif Azzopardi](http://www.strath.ac.uk/staff/azzopardileifdr/) we asked ourselves: can this finding of a "halo effect" be *reproduced* in a more natural Web setting? Our answer to this question is published in our [SIGIR 2017](http://sigir.org/sigir2017) short paper:
...
In particular, we implemented the halo effect on the site
