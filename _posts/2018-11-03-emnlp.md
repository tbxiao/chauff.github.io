...
Good to know: one of the baselines in the paper is [DrQA](https://github.com/facebookresearch/DrQA), a very popular question answering/reading comprehension baseline across a range of EMNLP papers, which itself was only released at last year's ACL.
